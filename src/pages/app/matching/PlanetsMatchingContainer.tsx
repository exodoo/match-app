        ...
        <Box className="card">
          <Box className="planets-matching-header">
            ...
            <Box className="planets-matching-action-container">
              <IconButton
                disabled={rateSending}
                onClick={() => handleRatePlanet(selected, -1)}
                color="error"
                className="planets-matching-action"
              >
                <CloseIcon />
              </IconButton>
              <IconButton
          ...
          <Box className="planets-matching-details">
            ...
            <Box className="planets-matching-details-pair">
              ...
              <Typography variant="body1">
                {selected?.star?.age ? `${selected?.star?.age}b` : "-"}
              </Typography>
            </Box>
          </Box>
        </Box>
